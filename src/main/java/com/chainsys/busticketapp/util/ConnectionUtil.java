...
public class ConnectionUtil {
	 ...
	 * "oracle"); } catch (Exception e) { e.printStackTrace(); throw new
	 * RuntimeException("Unable to get Database connection"); } return connection; }
	 */
	...
	public static Connection getConnection() throws DBException {
		...
		try {
			...
			connection = DriverManager.getConnection("jdbc:oracle:thin:@3.7.63.237:1521:XE", "vignesh", "vignesh");
